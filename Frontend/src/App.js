...
import { getUser, getUserActivity, getUserPerformance, getUserSessions } from './User'
...
* @return {void} - Nothing
*/
getUserActivity(USER_ID).then(result => {
...
getUserSessions(USER_ID).then(result => {
...
* @return {void} - Nothing
*/
getUserPerformance(USER_ID).then(result => {
